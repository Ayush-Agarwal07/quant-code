"""Command-line interface for QuantCode."""
...
from quant_code import __version__
from quant_code.core.exceptions import QuantForgeError
from quant_code.core.json_utils import write_model_json
from quant_code.strategy_research.schemas import MAIN_SCHEMA_NAMES
from quant_code.strategy_research.workflow import run_quant_research

app = typer.Typer(
    name="qf",
    help="QuantCode: a research-only agentic quant research prototype.",
...
def run(
    ...
    table = Table(title="QuantCode Research Summary", show_header=False)
