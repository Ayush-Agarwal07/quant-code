...
from quant_code.future.experiments import ExperimentRunnerStub
...
def run_quant_research(objective: str, model_provider: str = "mock") -> QuantResearchPacket:
    ...
    experiment_runner = ExperimentRunnerStub()
    experiment_results = [experiment_runner.run(plan) for plan in plans]
